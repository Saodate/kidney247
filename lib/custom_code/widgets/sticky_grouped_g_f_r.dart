...
class StickyGroupedGFR extends StatefulWidget {
  const StickyGroupedGFR(
      {Key? key,
      this.width,
      this.height,
  ...
  @override
  _StickyGroupedGFRState createState() => _StickyGroupedGFRState();
}

class _StickyGroupedGFRState extends State<StickyGroupedGFR> {
  @override
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(
              '${element.gFRTime!.day}/${element.gFRTime!.month}/${element.gFRTime!.year}',
    ...
    return Card(
      ...
      child: SizedBox(
          child: ListTile(
              ...
              subtitle: Text(
                '${DateFormat('hh:mm a').format(element.gFRTime!)}',
                style: TextStyle(
                    fontFamily: 'Primary Family',
                    color: widget.textColor,
                    fontWeight: FontWeight.bold),
