...
class StickyGroupedBUN extends StatefulWidget {
  const StickyGroupedBUN(
      {Key? key,
      this.width,
      this.height,
  ...
  @override
  _StickyGroupedBUNState createState() => _StickyGroupedBUNState();
}

class _StickyGroupedBUNState extends State<StickyGroupedBUN> {
  @override
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(
              '${element.bUNTime!.day}/${element.bUNTime!.month}/${element.bUNTime!.year}',
    ...
    return Card(
      ...
      child: SizedBox(
          child: ListTile(
              ...
              subtitle: Text(
                '${DateFormat('hh:mm a').format(element.bUNTime!)}',
                style: TextStyle(
                    fontFamily: 'Primary Family',
                    color: widget.textColor,
                    fontWeight: FontWeight.bold),
