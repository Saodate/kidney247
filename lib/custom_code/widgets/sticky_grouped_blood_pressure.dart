...
class StickyGroupedBloodPressure extends StatefulWidget {
  const StickyGroupedBloodPressure(
      {Key? key,
      this.width,
      this.height,
  ...
  @override
  _StickyGroupedBloodPressureState createState() =>
      _StickyGroupedBloodPressureState();
}

class _StickyGroupedBloodPressureState
    extends State<StickyGroupedBloodPressure> {
  @override
    ...
    return temp.isEmpty
        ...
        : StickyGroupedListView<VitalsResultRecord, DateTime>(
            ...
            groupBy: (VitalsResultRecord element) => DateTime(
                element.bloodPressureTime!.year,
                element.bloodPressureTime!.month,
                element.bloodPressureTime!.day),
            groupComparator: (DateTime value1, DateTime value2) =>
                value2.compareTo(value1),
            itemComparator:
                (VitalsResultRecord element1, VitalsResultRecord element2) =>
                    element2.bloodPressureTime!
                        .compareTo(element1.bloodPressureTime!),
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(
              '${element.bloodPressureTime!.day}/${element.bloodPressureTime!.month}/${element.bloodPressureTime!.year}',
    ...
    return Card(
      ...
      child: SizedBox(
          child: ListTile(
              ...
              title: Text(
                '${element.bloodPressureFrom!}-${element.bloodPressureTo!}',
                style: TextStyle(
                    fontFamily: 'Primary Family',
              ...
              subtitle: Text(
                '${DateFormat('hh:mm a').format(element.bloodPressureTime!)}',
                style: TextStyle(
                    fontFamily: 'Primary Family',
                    color: widget.textColor,
                    fontWeight: FontWeight.bold),
