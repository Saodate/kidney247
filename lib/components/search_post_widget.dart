...
class SearchPostWidget extends StatefulWidget {
  const SearchPostWidget({Key? key}) : super(key: key);

  @override
  _SearchPostWidgetState createState() => _SearchPostWidgetState();
}
              ...
              child: Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('SEARCH_POST_COMP_close_ICN_ON_TAP');
                      ...
                      return Padding(
                        ...
                        child: StreamBuilder<UsersRecord>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final containerPostsUsersRecord = snapshot.data!;
                            return Container(
                              width: double.infinity,
                              decoration: BoxDecoration(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SEARCH_POST_CircleImage_yqmo87q8_ON_TAP');
                                                  logFirebaseEvent(
                                          ...
                                          if (listItem.userRef ==
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'SEARCH_POST_COMP_Icon_rclzne0u_ON_TAP');
                                                logFirebaseEvent(
                                                    'Icon_bottom_sheet');
                                            ...
                                            if (listItem.image != '')
                                              Expanded(
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SEARCH_POST_COMP_Image_mk5eyr74_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Image_expand_image');
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'SEARCH_POST_COMP_Icon_ylxlg4iw_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Icon_bottom_sheet');
                                                          await showModalBottomSheet(
                                                            isScrollControlled:
                                                      ...
                                                      child: StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<PostCommentReplyRecord>
                                                              textPostCommentReplyRecordList =
                                                              snapshot.data!;
                                                          return Text(
                                                            (containerPostCommentsRecordList
                                                                        .length +
