                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'hc8nqw04' /* Fill out the information below... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                        ...
                                        text: containerAppointmentsRecord
                                            .description,
                                      ),
                                      obscureText: false,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'EDIT_APPOINTMENT_date_range_outlined_ICN');
                                                      logFirebaseEvent(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'EDIT_APPOINTMENT_COMP_CANCEL_BTN_ON_TAP');
                                            logFirebaseEvent(
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'EDIT_APPOINTMENT_COMP_SAVE_BTN_ON_TAP');
                                            logFirebaseEvent(
